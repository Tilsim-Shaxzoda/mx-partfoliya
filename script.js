class TerminalResume {
  ...
  handleCommand(inputElement) {
    ...
    switch (cmd) {
      ...
      case "exit-game":
        this.endGame();
        this.printToOutput(outputElement, "O'yin tugatildi.", "info");
        break;
      case "matrix":
      ...
      case "stop-matrix":
        ...
        this.printToOutput(outputElement, "Matrix effekti to'xtatildi.", "info");
        break;
      case "weather":
      ...
      default:
        this.printToOutput(
          outputElement,
          `Buyruq topilmadi: ${command}. Mavjud buyruqlarni ko'rish uchun 'help' yozing.`,
          "error"
        );
    }
...
╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝╚═════╝  ╚═════╝   ╚═══╝  `;
    ...
    const welcome =
      ...
      this.wrapWithColor(
        "         Interaktiv Terminal Rezyume — Tilsim Shaxzoda\n",
        "#888888"
      ) +
      this.wrapWithColor(
        "     Dasturiy Ta'minot Muhandisi • Backend • Kiberxavfsizlik\n",
        "#666666"
      ) +
      this.wrapWithColor(divider + "\n\n", "#555555") +
      this.wrapWithColor("Yozing ", "#666666") +
      this.wrapWithColor("'help'", "#87af87") +
      this.wrapWithColor(" — mavjud buyruqlarni ko'rish uchun\n", "#666666") +
      this.wrapWithColor("Bosing  ", "#666666") +
      this.wrapWithColor("'tab'", "#87af87") +
      this.wrapWithColor(" — buyruqni avtomatik to'ldirish", "#666666");
  ...
  showHelp(outputElement = this.output) {
    const title = this.wrapWithColor("🚀 Mavjud Buyruqlar\n\n", "#ffff00");

    const mainCommands =
      this.wrapWithColor("Asosiy Buyruqlar:\n", "#00ffff") +
      this.wrapWithColor("• help", "#98fb98") +
      "       " +
      this.wrapWithColor("Ushbu yordam xabarini ko'rsatish\n", "#ffffff") +
      this.wrapWithColor("• about", "#98fb98") +
      "      " +
      this.wrapWithColor("Men haqimda ma'lumot\n", "#ffffff") +
      this.wrapWithColor("• skills", "#98fb98") +
      "     " +
      this.wrapWithColor("Texnik ko'nikmalarimni ko'rish\n", "#ffffff") +
      this.wrapWithColor("• experience", "#98fb98") +
      " " +
      this.wrapWithColor("Ish tajribamni ko'rsatish\n", "#ffffff") +
      this.wrapWithColor("• education", "#98fb98") +
      "  " +
      this.wrapWithColor("Ta'lim ma'lumotlarim\n", "#ffffff") +
      this.wrapWithColor("• contact", "#98fb98") +
      "    " +
      this.wrapWithColor("Aloqa ma'lumotlarim\n", "#ffffff") +
      this.wrapWithColor("• clear", "#98fb98") +
      "      " +
      this.wrapWithColor("Terminalni tozalash\n", "#ffffff");

    const utilityCommands =
      "\n" +
      this.wrapWithColor("Qo'shimcha Buyruqlar:\n", "#00ffff") +
      this.wrapWithColor("• projects", "#98fb98") +
      "   " +
      this.wrapWithColor("Loyihalarimni ko'rish\n", "#ffffff") +
      this.wrapWithColor("• skills-visual", "#98fb98") +
      " " +
      this.wrapWithColor("Ko'nikmalar vizualizatsiyasi\n", "#ffffff") +
      this.wrapWithColor("• game", "#98fb98") +
      "      " +
      this.wrapWithColor("Mini o'yin o'ynash\n", "#ffffff") +
      this.wrapWithColor("• matrix", "#98fb98") +
      "    " +
      this.wrapWithColor("Matrix yomg'ir effektini boshlash\n", "#ffffff") +
      this.wrapWithColor("• weather", "#98fb98") +
      "   " +
      this.wrapWithColor("Ob-havo ma'lumotini ko'rish\n", "#ffffff") +
      this.wrapWithColor("• calc", "#98fb98") +
      "      " +
      this.wrapWithColor("Matematik ifodani hisoblash\n", "#ffffff") +
      this.wrapWithColor("• pdf", "#98fb98") +
      "       " +
      this.wrapWithColor("Rezyumeni PDF shaklda yuklab olish\n", "#ffffff") +
      this.wrapWithColor("• linkedin-cover", "#98fb98") +
      " " +
      this.wrapWithColor("LinkedIn muqova rasmini yaratish\n", "#ffffff");

    const shortcuts =
      "\n" +
      this.wrapWithColor("Tugmalar:\n", "#666666") +
      this.wrapWithColor("• ", "#666666") +
      this.wrapWithColor("↑/↓", "#666666") +
      "         " +
      this.wrapWithColor("Buyruqlar tarixini ko'rish\n", "#444444") +
      this.wrapWithColor("• ", "#666666") +
      this.wrapWithColor("Tab", "#666666") +
      "         " +
      this.wrapWithColor("Buyruqni avtomatik to'ldirish\n", "#444444") +
      this.wrapWithColor("• ", "#666666") +
      this.wrapWithColor("Ctrl+L", "#666666") +
      "      " +
      this.wrapWithColor("Ekranni tozalash\n", "#444444") +
      this.wrapWithColor("• ", "#666666") +
      this.wrapWithColor("Ctrl+Shift+H", "#666666") +
      " " +
      this.wrapWithColor("Gorizontal bo'lish\n", "#444444") +
      this.wrapWithColor("• ", "#666666") +
      this.wrapWithColor("Ctrl+Shift+V", "#666666") +
      " " +
      this.wrapWithColor("Vertikal bo'lish", "#444444");
  ...
  showAbout(outputElement = this.output) {
    const about = `<span style="color: #ff8c00; font-weight: bold;">✨ Men Haqimda</span>
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Zamonaviy dasturiy ta'minot muhandisi, Toshkentda",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "faoliyat yurituvchi — Xamidov Murodjon.",
      "#ffffff"
    )}
${this.wrapWithColor(
  "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor("⚡ Maqsad", "#ff8c00")}
${this.wrapWithColor(
  "   Murakkab texnologik tizimlarni tushunish va ularni",
  "#ffffff"
)}
${this.wrapWithColor("   samarali, kengaytiriladigan yechimlarga aylantirish", "#ff8c00")}

${this.wrapWithColor("⚡ Ixtisoslik", "#ff8c00")}
${this.wrapWithColor(
  "   Taqsimlangan tizimlar, ma'lumotlar oqimi (data pipelines)",
  "#ffffff"
)}
${this.wrapWithColor(
  "   va bulutli texnologiyalar — mikroservis arxitekturasi",
  "#ffffff"
)}

${this.wrapWithColor("⚡ Qo'shimcha", "#ff8c00")}
${this.wrapWithColor(
  "   Kiberxavfsizlikka qiziqish: tizimlarni chuqurroq tushunish,",
  "#ffffff"
)}
${this.wrapWithColor("   zaifliklarni tahlil qilish va mustahkam yechimlar", "#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Dasturlash — bu tizim yaratish va kelajak qurish!  ",
      "#ffffff"
...
${this.wrapWithColor(
  ...
  showExperience(outputElement = this.output) {
    const experience = `<span style="color: #ffff00; font-weight: bold;">💼 Ish Tajribasi</span>

<span style="color: #00ffff;">CYBER SECURITY PRACTICE | Xavfsizlik Tahlilchisi</span>
${this.wrapWithColor(
  "2023 - Hozir | Toshkent, O'zbekiston",
  "#ffffff"
)}
${this.wrapWithColor(
  "Kiberxavfsizlik amaliyoti va tizimlar xavfsizligi",
  "#98fb98"
)}

• ${this.wrapWithColor("Xavfsizlik tahlili", "#ffa07a")} - ${this.wrapWithColor(
      "Tizim zaifliklari va xavfsizlik testlari",
      "#ffffff"
    )}
• ${this.wrapWithColor(
      "Test muhitlari",
      ...
      "Amaliy tajriba uchun laboratoriya muhitlari sozlash",
      "#ffffff"
    )}
• ${this.wrapWithColor("Pentest", "#ffa07a")} - ${this.wrapWithColor(
      "Tarmoq va web ilovalar xavfsizligini tekshirish",
      "#ffffff"
    )}

<span style="color: #00ffff;">FREELANCE DEVELOPER | Mustaqil Dasturchi</span>
${this.wrapWithColor(
  "2021 - 2023 | Buxoro, O'zbekiston",
  "#ffffff"
)}

• ${this.wrapWithColor("OpenBudget Bot", "#ffa07a")} - ${this.wrapWithColor(
      "Davlat byudjet tizimi uchun botlar ishlab chiqish",
      "#ffffff"
    )}
• ${this.wrapWithColor("API integratsiya", "#ffa07a")} - ${this.wrapWithColor(
      "Tashqi servislar bilan bog'lanish va avtomatlashtirish",
      "#ffffff"
    )}
• ${this.wrapWithColor("Full-stack loyihalar", "#ffa07a")} - ${this.wrapWithColor(
      "Frontend va backend yechimlari yaratish",
      "#ffffff"
    )}

${this.wrapWithColor("Ishlatilgan texnologiyalar:", "#00ffff")} ${this.wrapWithColor(
      "Python, Node.js, React, REST API, Telegram Bot API, PostgreSQL",
      "#87cefa"
    )}

<span style="color: #00ffff;">ARMY TECH | Software Engineer</span>
${this.wrapWithColor(
  "2020 - 2021 | Nukus, O'zbekiston",
  "#ffffff"
)}

• ${this.wrapWithColor("Dasturlash asoslari", "#ffa07a")} - ${this.wrapWithColor(
      "Amaliy loyihalar va tizimlarni tushunish",
      "#ffffff"
    )}
• ${this.wrapWithColor("Tizim ishlab chiqish", "#ffa07a")} - ${this.wrapWithColor(
      "Birinchi professional dasturiy tajriba",
      "#ffffff"
    )}
• ${this.wrapWithColor("Jamoa bilan ishlash", "#ffa07a")} - ${this.wrapWithColor(
      "Texnik komanda ichida loyiha olib borish",
      "#ffffff"
    )}
...
${this.wrapWithColor("Ishlatilgan texnologiyalar:", "#00ffff")} ${this.wrapWithColor(
  ...
  showEducation(outputElement = this.output) {
    const education = `<span style="color: #ff8c00; font-weight: bold;">🎓 Ta'lim</span>
...
${this.wrapWithColor("🏛️  Muassasa:", "#ff8c00")}  ${this.wrapWithColor(
      "O'zbekiston Milliy Universiteti (yoki texnik ta'lim)",
      "#ffffff"
    )}
${this.wrapWithColor("📅 Davr:", "#ff8c00")}       ${this.wrapWithColor(
      "2018 - 2022",
      "#ffffff"
    )}
${this.wrapWithColor("📍 Joylashuv:", "#ff8c00")}  ${this.wrapWithColor(
      "O'zbekiston",
      "#ffffff"
    )}

${this.wrapWithColor("🛡️  Qo'shimcha:", "#ff8c00")} ${this.wrapWithColor(
      "Kiberxavfsizlik bo'yicha amaliy o'z-o'zini tayyorlash",
      "#ffffff"
    )}
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Dasturlash yo'limning boshlang'ich poydevori   ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "╰──────────────────────────────────────────────────╯",
  ...
  showSkills(outputElement = this.output) {
    const skills = `<span style="color: #ffff00; font-weight: bold;">🛠️ KO'NIKMALAR</span>

<span style="color: #00ffff;">Frontend:</span>
• ${this.wrapWithColor("React.js", "#ffffff")}
• ${this.wrapWithColor("Angular", "#ffffff")}
• ${this.wrapWithColor("Redux / MobX", "#ffffff")}
• ${this.wrapWithColor("Bootstrap / Material-UI", "#ffffff")}
• ${this.wrapWithColor("React Native / Ionic", "#ffffff")}
• ${this.wrapWithColor("HTML / CSS", "#ffffff")}

<span style="color: #00ffff;">Dasturlash Tillari:</span>
• ${this.wrapWithColor("JavaScript / TypeScript", "#ffffff")}
• ${this.wrapWithColor("Python", "#ffffff")}
• ${this.wrapWithColor("Java / Kotlin", "#ffffff")}
• ${this.wrapWithColor("SQL", "#ffffff")}

<span style="color: #00ffff;">Backend:</span>
• ${this.wrapWithColor("Node.js / Express.js", "#ffffff")}
• ${this.wrapWithColor("Firebase / Cloud Functions", "#ffffff")}
• ${this.wrapWithColor("AWS Lambda / AWS S3", "#ffffff")}
• ${this.wrapWithColor("NGINX", "#ffffff")}

<span style="color: #00ffff;">Bulutli Texnologiyalar & DevOps:</span>
• ${this.wrapWithColor("Google Cloud / AWS / Azure", "#ffffff")}
• ${this.wrapWithColor("Docker / Kubernetes", "#ffffff")}
• ${this.wrapWithColor("Terraform / Cloud Run", "#ffffff")}
• ${this.wrapWithColor("CI/CD", "#ffffff")}

<span style="color: #00ffff;">Ma'lumotlar Bazasi:</span>
• ${this.wrapWithColor("MongoDB / Firestore / RethinkDB", "#ffffff")}
• ${this.wrapWithColor("PostgreSQL / SQL Server", "#ffffff")}
• ${this.wrapWithColor("Redis / BigQuery", "#ffffff")}
• ${this.wrapWithColor("Elasticsearch", "#ffffff")}

<span style="color: #00ffff;">Arxitektura:</span>
• ${this.wrapWithColor("Mikroservislar", "#ffffff")}
• ${this.wrapWithColor("SaaS / Pub-Sub", "#ffffff")}
• ${this.wrapWithColor("GraphQL", "#ffffff")}
• ${this.wrapWithColor("Agile / Scrum / TDD", "#ffffff")}`;
  ...
  showContact(outputElement = this.output) {
    const contact = `<span style="color: #ff8c00; font-weight: bold;">📫 Aloqa Ma'lumotlari</span>
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://xamidovmurodjon.me" target="_blank" style="color: #ffffff; text-decoration: none;">xamidovmurodjon.me</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/Tilsim-Shaxzoda" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/Tilsim-Shaxzoda</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("📸", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://instagram.com/xamidov._.murodjon" target="_blank" style="color: #ffffff; text-decoration: none;">@xamidov._.murodjon</a>',
      "#ffffff"
    )}

${this.wrapWithColor("✈️", "#ff8c00")}  ${this.wrapWithColor(
      "Telegram:",
      "#ff8c00"
    )} ${this.wrapWithColor(
      '<a href="https://t.me/+1ohQlm0-9cMwZjE6" target="_blank" style="color: #ffffff; text-decoration: none;">Telegram Kanal</a>',
      "#ffffff"
    )}

${this.wrapWithColor("╭────────────────────────────────────────╮", "#ff8c00")}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Loyiha yoki hamkorlik uchun murojaat qiling!",
      "#ffffff"
    )} ${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  loadProjects() {
    this.projects = [
      {
        title: "MAX-CHAT",
        description: "Real vaqtda ishlaydiagan AI chatbot ilovasi",
        image: "",
        technologies: ["React", "Node.js", "AI"],
        demo: "https://max-chat-a2sv.onrender.com/",
        repo: "https://github.com/Tilsim-Shaxzoda",
      },
      {
        title: "OpenBudget Bot System",
        description: "Davlat byudjet tizimi uchun avtomatlashtirilgan botlar",
        image: "",
      ...
      {
        title: "Cyber Lab Projects",
        description: "Kiberxavfsizlik amaliyoti uchun laboratoriya muhitlari",
        image: "",
        technologies: ["Security", "Pentest", "Network"],
        demo: "#",
        repo: "https://github.com/Tilsim-Shaxzoda",
      },
      {
        title: "Shaxsiy Portfolio",
        description: "Neo-brutalizm uslubidagi shaxsiy portfolio sayti",
        image: "",
        technologies: ["HTML", "CSS", "JavaScript"],
        demo: "https://xamidovmurodjon.me",
        repo: "https://github.com/Tilsim-Shaxzoda",
      },
    ];
  }
  ...
  async generatePDF() {
    const outputElement = this.terminals[this.activeTerminal].input
      .closest(".terminal-content")
      .querySelector("[id^='output']");
    this.printToOutput(outputElement, "PDF rezyume yaratilmoqda...", "info");
    // Placeholder for actual PDF generation
    setTimeout(() => {
      this.printToOutput(
        outputElement,
        "PDF yaratish hozircha mavjud emas.",
        "error"
      );
    }, 1000);
  }
  ...
  initGame() {
    ...
    gameContainer.innerHTML = `
      <div class="game-instructions">
        <p>Ilon O'yini: Harakatlanish uchun o'q tugmalaridan foydalaning.</p>
        <p>P — to'xtatish, SPACE — qayta boshlash, ESC — chiqish.</p>
      </div>
      <div id="snake-game-score">Hisobni: 0</div>
    ...
    const sketch = (p) => {
      ...
      p.draw = () => {
        ...
        if (isPaused) {
          ...
          p.text("TO'XTATILDI", canvasWidth / 2, canvasHeight / 2);
          p.textSize(16);
          p.text("Davom etish uchun P ni bosing", canvasWidth / 2, canvasHeight / 2 + 30);
          return;
        }
        ...
        if (gameOver) {
          ...
          p.textSize(24);
          p.textAlign(p.CENTER, p.CENTER);
          p.text("O'yin Tugadi!", canvasWidth / 2, canvasHeight / 2 - 20);
          p.textSize(16);
          p.text(`Hisob: ${score}`, canvasWidth / 2, canvasHeight / 2 + 20);
          p.text(
            "Qayta boshlash uchun SPACE bosing",
            canvasWidth / 2,
            canvasHeight / 2 + 50
          );
          return;
  ...
  async showWeather(location, outputElement) {
    if (!location) {
      this.printToOutput(
        outputElement,
        "Iltimos, shahar nomini kiriting. Foydalanish: weather [shahar nomi]",
        "error"
      );
      return;
    }
    ...
    this.printToOutput(
      outputElement,
      `${location} uchun ob-havo ma'lumoti olinmoqda...`,
      "info"
    );
    ...
    try {
      ...
      const weatherHTML = `<div class="weather-container">
        <div class="weather-header">
          <span style="color: #ffff00; font-weight: bold;">🌤️ Ob-havo: ${
            data.name
        ...
        <div class="weather-body">
          ...
          <div class="weather-details">
            <div><span style="color: #87cefa;">His qilish:</span> ${Math.round(
              data.main.feels_like
            )}°C</div>
            <div><span style="color: #87cefa;">Namlik:</span> ${
              data.main.humidity
            }%</div>
            <div><span style="color: #87cefa;">Shamol:</span> ${Math.round(
              data.wind.speed * 3.6
            )} km/h</div>
          </div>
        </div>
      ...
      this.printToOutput(
        outputElement,
        `Ob-havo ma'lumotini olishda xatolik: ${error.message}`,
        "error"
      );
    }
  }
  ...
  calculate(expression, outputElement) {
    if (!expression) {
      this.printToOutput(
        outputElement,
        "Iltimos, matematik ifoda kiriting. Foydalanish: calc [ifoda]",
        "error"
      );
      return;
    }
    ...
    try {
      ...
      this.printToOutput(
        outputElement,
        `Xatolik: Ifodani hisoblash imkoni bo'lmadi. To'g'ri matematik ifoda kiriting.`,
        "error"
      );
    }
  }
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "murodjon@tilsim-shaxzoda: ~/rezyume";
...
╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝╚═════╝  ╚═════╝   ╚═══╝ `;
    ...
    subtitle.textContent = "Interaktiv Terminal Rezyume";
    ...
    role.textContent = "Dasturiy Ta'minot Muhandisi • Backend • Kiberxavfsizlik";
    ...
    helpTitle.textContent = "🚀 Mavjud Buyruqlar";
    ...
    mainCmdTitle.textContent = "Asosiy Buyruqlar:";
    ...
    const mainCommands = [
      { cmd: "about", desc: "Men haqimda ma'lumot" },
      { cmd: "skills", desc: "Ko'nikmalarni ko'rish" },
      { cmd: "experience", desc: "Ish tajribasini ko'rsatish" },
    ];
    ...
    utilityCmdTitle.textContent = "Qo'shimcha Buyruqlar:";
    ...
    const utilityCommands = [
      { cmd: "game", desc: "Mini o'yin o'ynash" },
      { cmd: "matrix", desc: "Matrix effektini boshlash" },
    ];
    ...
    url.textContent = "xamidovmurodjon.me";
